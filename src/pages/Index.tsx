        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-xl shadow-primary/5">
          ...
          <div className="mt-4 flex gap-3">
            <Button
              ...
              onClick={() => window.location.href = "https://app.techguygeek.co.uk/menu1/Digitalweb/Auth/google-start.php"}
            >
            ...
            <Button
              ...
              size="lg"
              className="flex-1 gap-2"
              onClick={() => window.location.href = "https://app.techguygeek.co.uk/menu1/Digitalweb/Auth/facebook-login.php"}
            >
